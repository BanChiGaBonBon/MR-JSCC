...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--feedforward', type=str, default='EXPLICIT-EQ', help='which decoder design to use, choose from [IMPLICIT | EXPLICIT-CE | EXPLICIT-CE-EQ | EXPLICIT-RES]')
        ...
        parser.add_argument('--v_min', type=int, default=0, help='')
        parser.add_argument('--v_range', type=int, default=0, help='')
        parser.add_argument('--v_max', type=int, default=500, help='')
        parser.add_argument('--v_step', type=int, default=0, help='')
        parser.add_argument('--real_cof', action='store_true', help='')
        parser.add_argument('--num_test', type=int, default=1000, help='how many test images to run')
        parser.add_argument('--pkt', type=str, default='OTFS_pkt', help='')
        ...
        parser.add_argument('--is_cm', action='store_true', help='channel on M')  

        parser.add_argument('--d_model', type=int, default=64, help='')
        parser.add_argument('--nhead', type=int, default=16, help='')
        # dataset parameters
