...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lambda_or', type=float, default=1, help='weights for the L2 loss')
        
        parser.add_argument('--tname', type=str, default='train',help='weights for the L2 loss')
