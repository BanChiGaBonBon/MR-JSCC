...
python test.py --dataset_mode 'CIFAR10' --v_min 0 --v_range 110 --v_step 10  --phase JSCCOFDM --modulation OFDM --S 16 --M 30 --pkt OFDM --K 8 --L 6 --C_channel 15 --N_pilot 2 --SNR 10 --feedforward 'EXPLICIT-EQ' --epoch 1126s16m30gat --is_ga --is_t --d_model 128 --is_cm
