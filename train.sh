...
# python3.8 train.py --gpu_ids '0' --feedforward 'EXPLICIT-EQ'  --n_downsample 2 --C_channel 15  --SNR 10 --dataset_mode 'CIFAR10' --n_epochs 50 --n_epochs_decay 600 --pkt OFDM --modulation OFDM --S 16 --M 30 --N_pilot 2 --K 8 --L 6 --v_range 150 --v_min 100 --batch_size 256 --tname '1129s16m30gat100150' --lr_policy 'cosine'  --is_ga --is_t --d_model 128
