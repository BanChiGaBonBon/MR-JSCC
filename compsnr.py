...
d2 = 'S25.0316s16m30res'

data2 = np.load('%s.npy'%d2,allow_pickle=True).tolist()


d3 = 'S25.0316s16m30tcm'
# d3 = '0724s32resv50'
data3 = np.load('%s.npy'%d3,allow_pickle=True).tolist()

d4 = 'S25.0316s16m30ceeqotfscm'
data4 = np.load('%s.npy'%d4,allow_pickle=True).tolist()

d5 = 'S25.0406s16m30lstmcm'
data5 = np.load('%s.npy'%d5,allow_pickle=True).tolist()

d6 = 'S25.0405s16m30ccm'
data6 = np.load('%s.npy'%d6,allow_pickle=True).tolist()

d7 = 'S25.0316s16m30cm'
data7 = np.load('%s.npy'%d7,allow_pickle=True).tolist()

data8 = np.load('S75.0316s16m30res.npy',allow_pickle=True).tolist()
data9 = np.load('S75.0316s16m30tcm.npy',allow_pickle=True).tolist()
data10 = np.load('S75.0316s16m30ceeqotfscm.npy',allow_pickle=True).tolist()
data11= np.load('S75.0406s16m30lstmcm.npy',allow_pickle=True).tolist()
data12 = np.load('S75.0405s16m30ccm.npy',allow_pickle=True).tolist()
data13 = np.load('S75.0316s16m30cm.npy',allow_pickle=True).tolist()

# data14 = np.load('q470.525snr.npy',allow_pickle=True).tolist()
data14 = {"-4": 0, "-2": 0, "0": 0, "2": 12.58934756375241, "4": 16.296711779508488, "6": 19.80009589425781, "8": 21.361728147494915, "10": 21.535730622794727, "12": 21.689157597125863, "14": 21.51518403466276, "16": 21.544250168586927}
# 创建时间点（x轴）
