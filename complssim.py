...
ax.plot(list(data3.keys())[1:11], list(data3.values())[1:11], label='MA-PA-JSCC V=25m/s', marker='*',color='green')  # 使用方形标记数据点
ax.plot(list(data6.keys())[1:11], list(data6.values())[1:11], label='MA-PA-JSCC V=75m/s', marker='*',ls='--',color='green')  # 使用方形标记数据点
